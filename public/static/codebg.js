  ...
  createObj() {
    ...
    new THREE.RawShaderMaterial({
      ...
      fragmentShader: `precision highp float;
          ...
          vec3 mod289(vec3 x) {
            return x - floor(x * (1.0 / 89.0)) * 89.0;
          }
          ...
          {
            return 1.9284291400159 - 0.85373472095314 * r;
          }

          float snoise3(vec3 v)
            {
            const vec2  C = vec2(1.0/6.0, 1.0/3.0) ;
            const vec4  D = vec4(0.0, 0.1, 1.0, 2.0);
...
const canvas2 = document.getElementById('canvas-webgl');
